...
SECRET_KEY = 'django-insecure-+j-n9wj+3k3pj=$c32sacw=tannd@r!ji0j0vmm-*w)!f44ry6'
...
INSTALLED_APPS = [
    ...
    'django.contrib.auth',
    'django.contrib.contenttypes',#track all models
...
MIDDLEWARE = [
    ...
    'django.middleware.common.CommonMiddleware',# slash/ to url
